...
public class ExcelUtility {
	...
	/**
	 * This method will return string value from excel
	 * @param sheetName
	 * @param rowNo
	 * @param cellNo
	 * @return
	 ...
	 */
	 public String getStringCellData(String sheetName, int rowNo, int cellNo) throws Throwable {
		 	 ...
		 	 //get data from excel
	FileInputStream file = new FileInputStream(IPathContants.EXCEL_FILEPATH);
	...
	/**
	 * This method will get numeric cell data
	 * 
	 * @param sheetName
	 * @param rowNum
	 * @param cellNo
	 ...
	 */
	 ...
	 public double getNumericCellData(String sheetName, int rowNum, int cellNo) throws Throwable {
		 FileInputStream file = new FileInputStream(IPathContants.EXCEL_FILEPATH);
		 Workbook workbook = WorkbookFactory.create(file);
		 
		 
		return workbook.getSheet(sheetName).getRow(rowNum).getCell(cellNo).getNumericCellValue();
	...
	public void writeDataIntoExcel(String sheetName, int rowNo, int cellNo, String value) throws Throwable {
		FileInputStream readfile = new FileInputStream(IPathContants.EXCEL_FILEPATH); 
		...
		FileOutputStream writeFile = new FileOutputStream(IPathContants.EXCEL_FILEPATH);
